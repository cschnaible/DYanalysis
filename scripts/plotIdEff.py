...
outputName = '~/CMSSW_7_4_6_patch6/src/DYanalysis/outputRoot/DYIdEff.root'
...
def make_plot(tree, variable, selection, binning, filename, xaxis='', title=''):
    ...
    if filename in ("leadMuonEtaIdEffSingleMu_rebin","subLeadMuonEtaIdEffSingleMu_rebin","leadMuonEtaIdEffDoubleMu_rebin","subLeadMuonEtaIdEffDoubleMu_rebin"):
       output_histo = output_histo.Rebin(4,"htemp",EtaBinning2) 
    if filename in ("zMIdEffSingleMu_rebin","zMIdEffDoubleMu_rebin"):
...
produce_acceptance(DYtree, singleMuonTree, "llM", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      MBinning1, #binning
                     'zMIdEffSingleMu', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     'M(#mu#mu) [GeV]', #xaxis
                     'Efficiency',
                     'Single Muon Data'
)
...
produce_acceptance(DYtree, singleMuonTree, "llM", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      MBinning1, #binning
                     'zMIdEffSingleMu_rebin', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     'M(#mu#mu) [GeV]', #xaxis
                     'Efficiency',
                     'Single Muon Data'
...
print " "
produce_acceptance(DYtree, singleMuonTree, "llY", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      YBinning, #binning
                     'zYIdEffSingleMu', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     'Y(#mu#mu)', #xaxis
                     'Efficiency',
                     'Single Muon Data'
...
print " "
produce_acceptance(DYtree, singleMuonTree, "llDPhi", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      DPhiBinning, #binning
                     'zDPhiIdEffSingleMu', #filename
                     'DiMuon Candidate ID Efficiency', #title
...
print " "
produce_acceptance(DYtree, singleMuonTree, "llPt", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      PtBinning, #binning
                     'zPtIdEffSingleMu', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     'p_{T}(#mu#mu)', #xaxis
                     'Efficiency',
                     'Single Muon Data'
...
print " "
produce_acceptance(DYtree, singleMuonTree, "lepPt[0]", etaSel+"&&"+muoSel+"&&"+isTight, etaSel+"&&"+muoSel, 
                      muoPtBinning, #binning
                     'leadMuonPtIdEffSingleMu', #filename
                     'Leading Muon ID Efficiency', #title
                     'p_{T}(#mu_{1})', #xaxis
                     'Efficiency',
                     'Single Muon Data'
)
print " "
produce_acceptance(DYtree, singleMuonTree, "lepPt[1]", etaSel+"&&"+muoSel+"&&"+isTight, etaSel+"&&"+muoSel, 
                      muoPtBinning, #binning
                     'subleadMuonPtIdEffSingleMu', #filename
                     'Subleading Muon ID Efficincy', #title
                     'p_{T}(#mu_{2})', #xaxis
                     'Efficiency',
                     'Single Muon Data'
)
print " "
produce_acceptance(DYtree, singleMuonTree, "lepEta[0]", ptSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+muoSel, 
                      EtaBinning1, #binning
                     'leadMuonEtaIdEffSingleMu', #filename
                     'Leading Muon ID Efficiency', #title
                     '#eta(#mu_{1})', #xaxis
                     'Efficiency',
                     'Single Muon Data'
...
print " "
produce_acceptance(DYtree, singleMuonTree, "lepEta[1]", ptSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+muoSel, 
                      EtaBinning1, #binning
                     'subleadMuonEtaIdEffSingleMu', #filename
                     'Subleading Muon ID Efficiency', #title
                     '#eta(#mu_{2})', #xaxis
                     'Efficiency',
                     'Single Muon Data'
)
...
produce_acceptance(DYtree, singleMuonTree, "lepEta[0]", ptSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+muoSel, 
                      EtaBinning1, #binning
                     'leadMuonEtaIdEffSingleMu_rebin', #filename
                     'Leading Muon ID Efficiency', #title
                     '#eta(#mu_{1})', #xaxis
                     'Efficiency',
                     'Single Muon Data'
...
produce_acceptance(DYtree, singleMuonTree, "lepEta[1]", ptSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+muoSel, 
                      EtaBinning1, #binning
                     'subleadMuonEtaIdEffSingleMu_rebin', #filename
                     'Subleading Muon ID Efficiency', #title
                     '#eta(#mu_{2})', #xaxis
                     'Efficiency',
                     'Single Muon Data'
...
print " "
produce_acceptance(DYtree, singleMuonTree, "lepPhi[0]", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      PhiBinning, #binning
                     'leadMuonPhiIdEffSingleMu', #filename
                     'Leading Muon ID Efficiency', #title
                     '#phi(#mu_{1})', #xaxis
                     'Efficiency',
                     'Single Muon Data'
...
print " "
produce_acceptance(DYtree, singleMuonTree, "lepPhi[1]", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      PhiBinning, #binning
                     'subleadMuonPhiIdEffSingleMu', #filename
                     'Subleading Muon ID Efficiency', #title
                     '#phi(#mu_{2})', #xaxis
                     'Efficiency',
                     'Single Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "llM", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      MBinning1, #binning
                     'zMIdEffDoubleMu', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     'M(#mu#mu) [GeV]', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
produce_acceptance(DYtree, doubleMuonTree, "llM", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      MBinning1, #binning
                     'zMIdEffDoubleMu_rebin', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     'M(#mu#mu) [GeV]', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "llY", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      YBinning, #binning
                     'zYIdEffDoubleMu', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     'Y(#mu#mu)', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "llDPhi", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      DPhiBinning, #binning
                     'zDPhiIdEffDoubleMu', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     '#Delta#phi(#mu#mu)', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "llPt", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      PtBinning, #binning
                     'zPtIdEffDoubleMu', #filename
                     'DiMuon Candidate ID Efficiency', #title
                     'p_{T}(#mu#mu)', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "lepPt[0]", etaSel+"&&"+muoSel+"&&"+isTight, etaSel+"&&"+muoSel, 
                      muoPtBinning, #binning
                     'leadMuonPtIdEffDoubleMu', #filename
                     'Leading Muon ID Efficiency', #title
                     'p_{T}(#mu_{1})', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "lepPt[1]", etaSel+"&&"+muoSel+"&&"+isTight, etaSel+"&&"+muoSel, 
                      muoPtBinning, #binning
                     'subleadMuonPtIdEffDoubleMu', #filename
                     'Subleading Muon ID Efficincy', #title
                     'p_{T}(#mu_{2})', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "lepEta[0]", ptSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+muoSel, 
                      EtaBinning1, #binning
                     'leadMuonEtaIdEffDoubleMu', #filename
                     'Leading Muon ID Efficiency', #title
                     '#eta(#mu_{1})', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "lepEta[1]", ptSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+muoSel, 
                      EtaBinning1, #binning
                     'subleadMuonEtaIdEffDoubleMu', #filename
                     'Subleading Muon ID Efficiency', #title
                     '#eta(#mu_{2})', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
produce_acceptance(DYtree, doubleMuonTree, "lepEta[0]", ptSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+muoSel, 
                      EtaBinning1, #binning
                     'leadMuonEtaIdEffDoubleMu_rebin', #filename
                     'Leading Muon ID Efficiency', #title
                     '#eta(#mu_{1})', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
produce_acceptance(DYtree, doubleMuonTree, "lepEta[1]", ptSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+muoSel, 
                      EtaBinning1, #binning
                     'subleadMuonEtaIdEffDoubleMu_rebin', #filename
                     'Subleading Muon ID Efficiency', #title
                     '#eta(#mu_{2})', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "lepPhi[0]", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      PhiBinning, #binning
                     'leadMuonPhiIdEffDoubleMu', #filename
                     'Leading Muon ID Efficiency', #title
                     '#phi(#mu_{1})', #xaxis
                     'Efficiency',
                     'Double Muon Data'
...
print " "
produce_acceptance(DYtree, doubleMuonTree, "lepPhi[1]", ptSel+"&&"+etaSel+"&&"+muoSel+"&&"+isTight, ptSel+"&&"+etaSel+"&&"+muoSel, 
                      PhiBinning, #binning
                     'subleadMuonPhiIdEffDoubleMu', #filename
                     'Subleading Muon ID Efficiency', #title
                     '#phi(#mu_{2})', #xaxis
                     'Efficiency',
                     'Double Muon Data'
